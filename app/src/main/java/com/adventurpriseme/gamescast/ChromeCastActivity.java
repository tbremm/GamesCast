...
import com.adventurpriseme.gamescast.GameView.ICellListener;
import com.adventurpriseme.gamescast.GameView.State;
...
public class ChromeCastActivity extends ActionBarActivity {
    ...
    private static final String APP_ID = "21857AF0";
    ...
    private void setFinished(
        ...
        new AlertDialog.Builder(ChromeCastActivity.this)
    ...
    private class MediaRouterCallback extends MediaRouter.Callback {
        ...
        public void onRouteSelected(MediaRouter router, RouteInfo route) {
            ...
            ChromeCastActivity.this.onRouteSelected(route);
        }

        @Override
        public void onRouteUnselected(MediaRouter router, RouteInfo route) {
            Log.d(TAG, "onRouteUnselected: " + route);
            ChromeCastActivity.this.onRouteUnselected(route);
        }
    }
